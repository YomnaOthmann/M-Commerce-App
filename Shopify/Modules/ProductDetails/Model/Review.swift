...
struct AllReview{
    static var goodReview:[Review] = [
        Review(name: "Ahmed Yousri", ratting: 5, date: "October 21, 2023", review: "I absolutely love this product! The quality is outstanding, and it exceeded my expectations. It's worth every penny."),
        Review(name: "Faisal", ratting: 4, date: "Jan 12, 2023", review: "These clothes are incredibly comfortable and stylish. The fit is perfect, and the fabric feels great against the skin."),
        Review(name: "Ibrahim", ratting: 4, date: "July 3, 2023", review: "These shoes are amazing! They provide excellent support and cushioning, making them perfect for long walks or runs. Plus, they look fantastic!"),
        Review(name: "Abu-Zeidr", ratting: 5, date: "May 28, 2023", review: "The product arrived earlier than expected, and the packaging was impeccable. The customer service was also top-notch. Highly recommended!"),
        Review(name: "Youmna Othman", ratting: 4, date: "Feb 15, 2023", review: "I'm thrilled with the quality and durability of these clothes. They have held up well even after multiple washes. I'll definitely be buying more."),
    ]
